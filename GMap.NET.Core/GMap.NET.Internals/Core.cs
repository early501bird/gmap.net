        ...
        void UpdateBounds()
        {
            ...
            try
            {
               ...
               // ----------------------------
                        ...
                        if (p.X >= minOfTiles.Width && p.Y >= minOfTiles.Height && p.X <= maxOfTiles.Width * scaleX && p.Y <= maxOfTiles.Height)
                        {
                            ...
                            dt.PosXY.X = dt.PosXY.X % ((long)Math.Pow(2,zoom));
                            if (!tileDrawingList.Contains(dt))// && dt.PosPixel.X<=1280)
                            {
                                tileDrawingList.Add(dt);
                                Debug.WriteLine("add point:"+dt);
                            }
                        }
                    }
                }
                ...
                {
                    tileDrawingList.Add(tileDrawingList[0]);
                    tileDrawingList.Add(tileDrawingList[1]);
